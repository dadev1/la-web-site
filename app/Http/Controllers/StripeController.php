...
class StripeController extends Controller
{
    ...
    public function transaction_save(Request $request)
    {
        ...
        if ($trans_check == null) {
            ...
            $email = DB::table('users')->where('stripe_id', $stripe_id)->value('email');
    ...
    public function sendInvoice() {
        ...
        $sent = $stripe->invoices->sendInvoice(
            'in_1LRtwhBc2bHS5nE0sBzfBXRP',
            []
        );
        return $sent;
    }
    ...
    public function sendInvoiceTest() {
        ...
        $stripe->invoiceItems->create(
            ['customer' => 'cus_M6rWyKEMkyh41n', 'price' => 'price_1LR9dpBc2bHS5nE0hsVuQXKZ']
        );
        $invoice = $stripe->invoices->create(
            [
                'customer' => 'cus_M6rWyKEMkyh41n',
        ...
        // $result = $stripe->invoices->sendInvoice($invoice_id, []);
        return $result;
