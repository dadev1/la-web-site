...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    //route purchase get registered dealers
    Route::get('get/purchase/admin/registered_dealers', [FrontendController::class,  'get_registered_dealers']);
...
//Job Apply APIS
Route::post('applyjob/send', [JobApplyController::class, 'applicant_proposal']);
