        ...
        <div class="body row">
            <div class="body-pannel col-md-3 col-sm-12">
                ...
                <div class="pannel" :style="{'border': ias_name == true && ias_cat_id == 1 ? '#007FED 2px solid' : ''}">
                    ...
                    <div class="foot">
                        <b-button v-if="language='en'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '1', amount: '360', currency: 'USD'}}">{{$t('subscribe')}}</b-button>
                        <b-button v-if="language='jp'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '1', amount: '36000', currency: 'JPY'}}">{{$t('subscribe')}}</b-button>
                    </div>
                </div>
            </div>
            <div class="body-pannel col-md-3 col-sm-12">
                <div class="pannel" :style="{'border': ias_name == true && ias_cat_id == 2 ? '#007FED 2px solid' : ''}">
                    ...
                    <div class="foot">
                        <b-button v-if="language='en'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '2', amount: '1000', currency: 'USD'}}">{{$t('subscribe')}}</b-button>
                        <b-button v-if="language='jp'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '2', amount: '100000', currency: 'JPY'}}">{{$t('subscribe')}}</b-button>
                    </div>
                </div>
            </div>
            <div class="body-pannel col-md-3 col-sm-12">
                <div class="pannel" :style="{'border': ias_name == true && ias_cat_id == 3 ? '#007FED 2px solid' : ''}">
                    ...
                    <div class="foot">
                        <b-button v-if="language='en'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '3', amount: '3600', currency: 'USD'}}">{{$t('subscribe')}}</b-button>
                        <b-button v-if="language='jp'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '3', amount: '360000', currency: 'JPY'}}">{{$t('subscribe')}}</b-button>
                    </div>
                </div>
            </div>
            <div class="body-pannel col-md-3 col-sm-12">
                <div class="pannel" :style="{'border': ias_name == true && ias_cat_id == 4 ? '#007FED 2px solid' : ''}">
                    ...
                    <div class="foot">
                        <b-button v-if="language='en'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '4', amount: '14400', currency: 'USD'}}">{{$t('subscribe')}}</b-button>
                        <b-button v-if="language='jp'" variant="outline-primary" :to="{name: 'plan', query: {app_id: '1', cat_id: '4', amount: '1440000', currency: 'JPY'}}">{{$t('subscribe')}}</b-button>
                    </div>
                </div>
            </div>
        </div>
