    ...
    <div>
        ...
        <div v-if="user">
            ...
            <div v-else>
                            ...
                            <div class="pannel">
                                ...
                                <div class="read">
                                    <h6>
                                        <router-link
                                            :to="{name: 'information_detail_en', query: {id: info.id, author: info.name}}">
                                            {{language == 'en' ? "read details" : "詳細を読む"}} >>
                                        </router-link>
                                    </h6>
                                </div>
                            </div>
                ...
                <div v-if="language=='en'" class="container brochure">
                    <div class="title">
...
<script>
import IAS from '~/components/contents/dealer-order/IAS'
import Flowcal from '~/components/contents/dealer-order/Flowcal'
