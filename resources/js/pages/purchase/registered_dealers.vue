    ...
    export default {
        data() {
            return {
                ...
                fields: [
                { key: 'index', label: '#'},
                { key: 'company_name', label: this.$root.$i18n.tc('Company Name')},
                { key: 'seo_name', label: this.$root.$i18n.tc('SEO/Person')},
                { key: 'name', label: this.$root.$i18n.tc('Name')},
                { key: 'nike_name', label: this.$root.$i18n.tc('Nike Name')},
                { key: 'email', label: this.$root.$i18n.tc('email')},
                { key: 'addresss1', label: this.$root.$i18n.tc('Addresss1')},
                { key: 'phone', label: this.$root.$i18n.tc('Phone')},
                { key: 'zip', label: this.$root.$i18n.tc('Zip Code')},
                { key: 'company_site', label: this.$root.$i18n.tc('Company Website')},
                { key: 'transaction_con', label: this.$root.$i18n.tc('Transaction Condition')},
                { key: 'deposit_amount', label: this.$root.$i18n.tc('Deposit Amount')},
                { key: 'deaprtment', label: this.$root.$i18n.tc('Department')},
                { key: 'subscribe', label: this.$root.$i18n.tc('Subscribe')},
        ...
        methods: {            
            ...
            async getRegisteredDealers(id){
                const {data} = await axios.get('/api/get/purchase/admin/registered_dealers')
                console.log(data)
                for (let i = 0; i < data.length; i++) {
                    ...
                    data[i].subscribe = data[i].subscribe == undefined ? "No" : "Yes";
                }
                this.items = data
                this.totalRows = this.items.length
            }
